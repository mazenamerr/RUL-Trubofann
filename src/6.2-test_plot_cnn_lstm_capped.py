...
model_path = os.path.join(DATA_DIR, f"cnn_lstm_rul_capped_seq{SEQ_LEN}.pt")
...
eval_csv_path   = os.path.join(DATA_DIR, f"test_eval_cnn_lstm_capped_seq{SEQ_LEN}.csv")
worst_csv_path  = os.path.join(DATA_DIR, f"worst_10_cnn_lstm_capped_seq{SEQ_LEN}.csv")
final_out = os.path.join(DATA_DIR, f"final_test_results_cnn_lstm_capped_seq{SEQ_LEN}.csv")

scatter_path = os.path.join(plots_cnn_lstm_dir, f"pred_vs_true_cnn_lstm_capped_seq{SEQ_LEN}.png")
hist_path    = os.path.join(plots_cnn_lstm_dir, f"error_histogram_cnn_lstm_capped_seq{SEQ_LEN}.png")
abs_err_path = os.path.join(plots_cnn_lstm_dir, f"abs_error_vs_true_cnn_lstm_capped_seq{SEQ_LEN}.png")
cdf_path     = os.path.join(plots_cnn_lstm_dir, f"cdf_abs_error_cnn_lstm_capped_seq{SEQ_LEN}.png")
...
plt.title("Predicted vs True RUL (CNN-LSTM Capped Model)", fontweight="bold")
...
plt.title("Distribution of Pred. Err. (CNN-LSTM Capped Model)", fontweight="bold")
...
plt.title("Absolute Error vs True RUL (CNN-LSTM Capped Model)", fontweight="bold")
...
plt.ylabel("CDF")
plt.title("CDF of Absolute Pred. Err. (CNN-LSTM Capped Model)", fontweight="bold")
